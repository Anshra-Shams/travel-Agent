@php
    ...
    $q = null;
@endphp
<x-admin-layout title="Create Quotation">
    <div class="no-print mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-0.5 text-sm text-gray-500">Build a quotation from <span class="font-medium text-gray-700">{{ $requirement->customer->name }}</span>'s {{ $requirement->service_type }} requirements.</p>
            </div>
