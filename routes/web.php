...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    ...
    Route::get('/service-types/create', [ServiceTypeController::class, 'create'])
        ->name('service-types.create');

    Route::post('/service-types', [ServiceTypeController::class, 'store'])
        ->name('service-types.store');

    Route::get('/service-types/{serviceType}/edit', [ServiceTypeController::class, 'edit'])
    ...
    */
    ...
    Route::post('/accounts/categories', [AccountController::class, 'storeCategory'])
        ->name('accounts.categories.store');
    ...
    */
    ...
    Route::get('/quotations/requirement', [QuotationController::class, 'requirement'])
        ->name('quotations.requirement');
    ...
    */
    ...
    Route::get('/services/type/{serviceType}', [ServicesController::class, 'serviceTypeShow'])
        ->name('services.type');
    ...
    */
    ...
    Route::patch('/leads/{lead}/assign', [LeadController::class, 'assignAgent'])
        ->name('leads.assign');

    Route::post('/leads/{lead}/follow-ups', [LeadController::class, 'storeFollowUp'])
        ->name('leads.follow-ups.store');

    Route::patch('/follow-ups/{followUp}/complete', [LeadController::class, 'completeFollowUp'])
    ...
    */
    ...
    Route::post('/customers/{customer}/follow-ups', [CustomerController::class, 'storeFollowUp'])
        ->name('customers.follow-ups.store');

    Route::patch('/customer-follow-ups/{followUp}/complete', [CustomerController::class, 'completeFollowUp'])
        ->name('customer-follow-ups.complete');
